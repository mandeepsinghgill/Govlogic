...
# CORS middleware - Conditional based on environment
# Local dev (DEBUG=True): CORS enabled in FastAPI for direct localhost access
# Production (DEBUG=False): CORS disabled, handled by Caddy reverse proxy to avoid duplicate headers
if settings.DEBUG:
    app.add_middleware(
        CORSMiddleware,
