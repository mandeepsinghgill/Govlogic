...
class EnhancedExportService:
    ...
    def _set_document_properties(self, doc: Document, proposal_data: Dict[str, Any]):
        ...
        core_properties.author = proposal_data.get('company', {}).get('name', 'GovLogicAI')
        core_properties.comments = 'Generated by GovLogicAI - Advanced Government Contracting Platform'
    ...
    def _add_headers_footers(self, doc: Document, proposal_data: Dict[str, Any]):
        ...
        footer_para.text = f"{proposal_data.get('company', {}).get('name', 'GovLogicAI')} - Confidential"
